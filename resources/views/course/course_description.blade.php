            ...
            <div class="flex-1 space-y-6">
                ...
                <section class="border border-[#e5e7eb] rounded-md p-4 text-[13px] text-[#1a1a1a] leading-[1.4]">
                    ...
                    <div class="text-[17px] leading-[1.4]">
                        <p class="mb-2">
                            Laravel 12 hadir dengan berbagai fitur baru yang lebih efisien dan powerful.
                            <strong>Smart Blog Apps dengan Integrasi AI</strong> adalah aplikasi blog modern yang memanfaatkan teknologi kecerdasan buatan untuk meningkatkan pengalaman pengguna, membantu penulis menghasilkan konten berkualitas, dan mengoptimalkan performa blog secara keseluruhan.
                        </p>
                        <p class="mb-2">
                            Dunia Coding menghadirkan <strong>course eksklusif</strong> bagi kamu yang ingin menguasai
                            <strong>Laravel 12 Mastery: Membuat Smart Blog Apps dengan Integrasi AI</strong>. Dipandu oleh
                            <strong>Dimas Bregas Full Stack Web Developer di ITQOM</strong>, course ini dirancang untuk membantu kamu membangun
                            <strong>Smart Blog dengan Laravel 12</strong>.
                        </p>
                        <p class="mb-2">
                            Dalam course ini, kamu akan memulai dari dasar dengan <em>mempelajari</em> pengenalan, instalasi, dan konfigurasi Laravel 12, lalu melanjutkan ke penggunaan <strong>Faker &amp; Seeder</strong> untuk mengisi database secara otomatis, sehingga proses pengelolaan data menjadi lebih efisien. Tak hanya itu, kamu juga akan <strong>menguasai fitur CRUD (Create, Read, Update, Delete)</strong> untuk postingan blog, serta membangun sistem autentikasi yang aman menggunakan Laravel Breeze dan middleware.
                        </p>
                        <p>
                            Yang membuat course ini semakin menarik adalah <strong>integrasi Gemini AI</strong>, yang memungkinkan blog kamu memiliki fitur <em>smart content suggestions</em> untuk memberikan rekomendasi konten secara otomatis. Di akhir pembelajaran, kamu akan mampu <strong>mendesain halaman utama blog yang menarik, interaktif, dan responsif.</strong>
                        </p>
                    </div>
                </section>
            </div>

...
<section id="class" class="py-16 px-6 bg-gray-100">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <a href="/course_description/{{ $course->id }}" class="block bg-white rounded-xl shadow p-4 hover:shadow-lg transition transform hover:scale-105 active:scale-95">Add commentMore actions

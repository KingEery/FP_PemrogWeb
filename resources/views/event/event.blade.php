...
<body class="bg-gray-50 flex flex-col min-h-screen">
  ...
  <section class="px-[5%] py-12 flex-1">
    <div class="flex flex-wrap md:flex-nowrap gap-8">
      <!-- KATEGORI: Removed sticky positioning -->
        ...
        <div class="w-full md:w-[280px] rounded-lg overflow-hidden shadow-sm bg-white transition-all duration-300" id="kategoriDropdown">
          ...
          <div class="overflow-hidden transition-all duration-500 max-h-0" id="dropdownContent">
            <div class="py-2">
              ...
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="product-management" value="product-management" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Product Management</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="qa" value="qa" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Quality Assurance</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="digital-marketing" value="digital-marketing" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Digital Marketing</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="cyber-security" value="cyber-security" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Cyber Security</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="career-dev" value="career-dev" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Career Development</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="tech-entrepreneur" value="tech-entrepreneur" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Tech Entrepreneur</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="freelancer" value="freelancer" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Freelancer</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="content-creator" value="content-creator" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Content Creator</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="academic-mentoring" value="academic-mentoring" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Academic Mentoring</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="data" value="data" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Data</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="devops" value="devops" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Dev Ops</span>
                </label>
              </div>
              <div class="py-1 px-5">
                <label class="flex items-center py-1">
                  <input type="radio" name="category" id="game-dev" value="game-dev" class="w-5 h-5 border border-gray-300 rounded-full text-purple-600 focus:ring-0 focus:ring-offset-0">
                  <span class="ml-3 text-gray-800">Game Development</span>
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
          <div class="w-full bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg" data-category="web-programming">
            ...
            <div class="p-5">
              ...
              <a href="#" class="text-purple-600 font-bold text-base inline-block py-1.5 relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-purple-600 after:left-0 after:bottom-0 hover:after:w-full after:transition-all after:duration-300">Gratis</a>
            </div>
          </div>

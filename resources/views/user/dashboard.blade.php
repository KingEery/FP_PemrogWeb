    ...
    <section class="bg-gray-50 min-h-screen text-gray-800 font-sans">
        <div class="max-w-6xl mx-auto px-6 pt-24">
            ...
            <div class="mb-10">
                ...
                <p class="text-gray-600 mt-2">Selamat datang kembali, <span class="font-semibold text-purple-700"></span>!
                    Berikut ringkasan aktivitas dan progresmu.</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-10">
                <div class="bg-white shadow rounded-lg p-6 flex justify-between items-center">
                    ...
                    <a href="#"
                        class="bg-purple-800 text-white font-bold px-4 py-2 rounded-lg hover:bg-purple-900 transition">Mulai</a>
                </div>

                <div class="bg-white shadow rounded-lg p-6 flex justify-between items-center">
                    <div>
                        <h3 class="text-xl font-bold text-purple-800">Lihat Sertifikat</h3>
                        <p class="text-sm text-gray-600">Sertifikat kompetensi tersedia untuk diunduh.</p>
                    </div>
                    <a href="{{ route('certificate') }}"
                        class="bg-purple-800 text-white font-bold px-4 py-2 rounded-lg hover:bg-purple-900 transition">Lihat</a>
                </div>
            </div>
